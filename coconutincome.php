...
if (isset($_POST['submit'])) { 
   ...
   $amount = $mysqli->escape_string($_POST['amount']);
	$query="INSERT into coconutincome (member_ref,reciept_no,date,amount) values($member_ref,'$reciept','$date','$amount')";
			...
			<div class="main-page">
				<div class="forms">
					...
					<?php
					 ...
					 ?>
						<h3 class="title1">Coconut : <?php echo $_GET['name']; ?></h3>
					...
					<p id="msg"></p>
						<table id="myTable" class="table">
							...
							<tbody>
								<?php
									$query = "SELECT * FROM coconutincome where member_ref=".$_GET['id']."";  
								...
								{ 
								  ...
								  <td>
								  <input type="button" name="view" value="Edit" id="" class="btn btn-primary  view_data" /> 
