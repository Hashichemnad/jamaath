...
if (isset($_POST['submit'])) { 
   ...
   $member_ref = $mysqli->escape_string($_POST['member_ref']);
   $reciept= $mysqli->escape_string($_POST['reciept']);
   $amount = $mysqli->escape_string($_POST['amount']);
	$query="INSERT into foodincome (member_ref,reciept_no,date,amount) values($member_ref,'$reciept','$date','$amount')";
			...
			<div class="main-page">
				<div class="forms">
					...
					<?php
					 ...
					 ?>
						<h3 class="title1">Food : <?php echo $_GET['name']; ?></h3>
						<div class="form-three widget-shadow">
							<form class="form-horizontal" action="" method="post">
							<input type="hidden" name="member_ref" value="<?php echo $_GET['id'];?>" required>
							<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" name="amount" value="1000" class="form-control1" id="focusedinput" placeholder="Enter Amount" required>
									</div>
								</div>
					...
					<p id="msg"></p>
						<table id="myTable" class="table">
							...
							<tbody>
								<?php
									$query = "SELECT * FROM foodincome where member_ref=".$_GET['id']."";  
								...
								{ 
								  ...
								  <td>
								  <input type="button" name="view" value="Edit" id="'.$row["food_id"].'" class="btn btn-primary view_data" /> 
								  <form action="" method="post"><input type="hidden" name="piid" value=""><input type="submit" name="" class="btn btn-danger" value="delete"></form></td>
								  </tr>';
								}
								?>
							</tbody>
