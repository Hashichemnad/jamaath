...
if (isset($_POST['new_year'])) { 
   ...
   $year = $mysqli->escape_string($_POST['year']);
    $query = "SELECT member_id,amount FROM members,category where members.category_ref=category.category_id order by member_id asc";  
    $result = mysqli_query($connect, $query); 

	while($row = mysqli_fetch_array($result))  
	{
        $query1="INSERT into annualpayment (member_ref,date,year,amount) values(".$row['member_id'].",'$date','$year','".$row['amount']."')";
        $a=mysqli_query($connect,$query1);
        $no=$no+$a;
    }
        $_SESSION['alert']="Added Successfully $no rows";
        $_SESSION['code']=200;
       }
...
<?php include 'header.php'; ?>
		...
		<div id="page-wrapper">
			...
			<div class="col_3">
			<?php
			$in = mysqli_fetch_array(mysqli_query($connect, "select (SELECT SUM(amount) as amount1 FROM annualpaymentpaid) as t1, (select SUM(amount) as amount2 from income) as t2, (select SUM(amount) as amount3 from workpayment) as t3, (select SUM(amount) as amount4 from foodincome)"));
			$out = mysqli_fetch_array(mysqli_query($connect, "select (SELECT SUM(amount) as amount1 FROM expense) as t1, (select SUM(amount) as amount2 from workexpense) as t2"));
			$pending = mysqli_fetch_array(mysqli_query($connect, "select (SELECT SUM(amount) as amount1 FROM annualpayment) as t1, (select SUM(amount) as amount2 from annualpaymentpaid) as t2"));
			$users = mysqli_fetch_array(mysqli_query($connect, "SELECT count(*) as count FROM members"));
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong>$<?php echo ($in['t1']+$in['t2']+$in['t3']+$in['t4'])-($out['t1']+$out['t2']); ?></strong></h5>
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong>$<?php echo ($in['t1']+$in['t2']+$in['t3']+$in['t4']); ?></strong></h5>
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong>$<?php echo ($out['t1']+$out['t2']); ?></strong></h5>
                      <span>Total Amount Out</span>
                    </div>
                </div>
        	</div>
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong>$<?php echo ($pending['t1']-$pending['t2']); ?></strong></h5>
        	...
        	<div class="col-md-3 widget">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong><?php echo $users['count']; ?></strong></h5>
        	...
        	<div class="clearfix"> </div>
                    ...
                    <h3 class="title1">Year Wise Statistics:</h3>
						<div class="table-responsive">
							...
							<table id="myTable" class="table">
								...
								<tbody>
									<?php
									$query = "SELECT * FROM annualpayment where mid=$mid order by apid desc";  
									$result = mysqli_query($connect, $query);  
									while($row = mysqli_fetch_array($result))  
								{ 
								  ...
								  <td>'.$row['done'].'</td>
								  <td>
								  <input type="button" name="view" value="View More" id="'.$row["piid"].'" class="btn btn-success  view_data" /> 
								  <form action="#" method="post"><input type="hidden" name="piid" value="'.$row['piid'].'"><input type="submit" name="remove" class="btn btn-danger" value="delete"></form></td>
								  </tr>';
								}
								?>
								</tbody>
						...
						<div class="form-three widget-shadow">
							<form class="form-horizontal" action="" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="number" name="year" class="form-control1" id="focusedinput"
											placeholder="Enter Year" required>
									</div>
								</div>
								<button type="submit" name="new_year" class="btn btn-primary">Submit</button>
							</form>
						</div>
					</div>
        </div>
