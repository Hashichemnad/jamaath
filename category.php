...
if (isset($_POST['update'])) { 
   ...
   $query="UPDATE category set category_name='$name',amount='$amount' where category_id=$category_id";
...
<?php include 'header.php'; ?>
		...
		<!-- main content start-->
		<div id="page-wrapper">
		<a href="categorynew.php" style="float: right;"><input type="button" name="view" value="New Category" class="btn btn-primary" /></a><br>
		<?php
						...
						<table id="myTable" class="table">
							...
							<tbody>
								...
								{ 
								  ...
								  <td>'.$row['amount'].'</td>
								  <td>
								  <input type="button" name="view" value="Edit" id="'.$row["category_id"].'" class="btn btn-primary  view_data" /> 
								  <form action="" method="post"><input type="hidden" name="category_id" value=""><input type="submit" onclick="return confirm(\'Are you sure you want to delete?\');" name="delete" class="btn btn-danger" value="delete"></form></td></tr>';
								}
								?>
							</tbody>
						</table>
