...
if (isset($_POST['submit'])) { 
   ...
   $query="INSERT into works (work_name,date,description) values('$name','$date','$descr')";
						...
						<div class="form-three widget-shadow">
							<form class="form-horizontal" action="" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="date" name="date" class="form-control1" id="focusedinput" placeholder="Enter Date" required>
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Description</label>
									<div class="col-sm-8">
										<input type="text" name="descr" class="form-control1" id="focusedinput" placeholder="Description of the work" required>
									</div>
								</div>
