...
if (isset($_POST['submit'])) { 
   ...
   $mob = $mysqli->escape_string($_POST['contact']);
   $relation = $mysqli->escape_string($_POST['relation']);
   $mid = $mysqli->escape_string($_POST['mid']);
   $query="INSERT into submember (member_ref,name,relation,contact) values($mid,'$name','$relation','$mob')";
						...
						<div class="form-three widget-shadow">
							<form class="form-horizontal" action="" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" name="contact" class="form-control1" id="focusedinput" placeholder="Enter mobile number">
									</div>
								</div>
